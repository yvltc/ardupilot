    ...
    AP_CustomControl_Backend(frontend, ahrs, tecs, dt)
{
    ...
    // saturation limits
    // ddmax = 30*M_PI/180;
    ddmax = 45*M_PI/180/0.9;
    dtmax = 1;
    dtmin = 0;

    // SOD - each vector is a row
    SOD_A.a = {0.972265023112481,0.006163328197227,0};
    SOD_A.b = {-5.546995377503851,0.232665639445301,0};
    SOD_A.c = {0,0,0};
    SOD_B.a = {5.546995377503851,0,0};
    SOD_B.b = {-690.6009244992297,0,0};
    SOD_B.c = {0,0,0};
    SOD_C.a = {0.986132511556241,0.003081664098613,0};
    SOD_C.b = {0,0,0};
    SOD_C.c = {0,0,0};
    SOD_D.a = {2.773497688751926,0,0};
    SOD_D.b = {0,0,0};
    SOD_D.c = {0,0,0};
    ...
    // tau = 0.25s
    _CFu_A = 0.960784313725490;
    _CFu_B = 0.039215686274510;
    _CFu_C = 0.980392156862745;
    _CFu_D = 0.019607843137255;
...
{  
    ...
    // limitar pedidos de rolamento
    saturate(-6000, 6000, &roll_target);
    ...
    if (is_gliding)
    {
        ...
        invG.b = {0,-94.0491,-0.149343148699802};
        invG.c = {0,0.808544953905735,8.122469099061590};
    }
    else
    {
        // fwztrim.G
        invG.a = {788.1938146491041,0,-8.017395459285762};
        invG.b = {0,-94.049137236000560, -0.1493};
    ...
    niu.x = Kff*error.x - Kp*angular_rates.x;
