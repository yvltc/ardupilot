...
float AP_CustomControl_INDI::get_roll_out(float roll_target)
{
    ...
    gcs().send_text(MAV_SEVERITY_INFO, "Timestamp: %lu microseconds", timestamp);
    ...
    snprintf(buffer, sizeof(buffer), "roll INDI custom controller working, u_0[0] u_0[1] dt: %.2f %.2f %f", u_0[0]*180/M_PI,  u_0[1]*180/M_PI, _dt);
