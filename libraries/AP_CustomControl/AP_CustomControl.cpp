...
const AP_Param::GroupInfo AP_CustomControl::var_info[] = {
    ...
    AP_SUBGROUPVARPTR(_backend, "2_", 4, AP_CustomControl, _backend_var_info[1]),
...
void AP_CustomControl::init(void)
{
    switch (CustomControlType(_controller_type))
    {
        ...
        case CustomControlType::CONT_INDI:
            ...
            _backend = new AP_CustomControl_INDI(*this, _pitchController, _rollController, _yawController, _ahrs, _tecs, _dt);
